...
<div class="alert alert-success alert-dismissible bg-danger text-white border-0 fade show" role="alert">
    ...
    @endif
        <div class="row justify-content-center">
            <div class="col-md-12">
                <form action="{{ route('user.brsr.sectionp9store') }}" id="social_store" role="form" method="post"
       ...
       <div class="card card-success card-outline mt-4">
            ...
            <b>Essential Indicators</b> <br /><br />
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment1[{{ $b }}][consumer_compliant]" id="consumer_compliant_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($principle9_ques2->where('question_section','total_turnover') as $key => $segment2)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea style="text-align: left;" name="segment2[{{ $b }}][turnover_percent]" id="turnover_percent_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)"></textarea>
                                                            </td>
        ...
        <table class="table table-bordered table-hover table-sm table-striped" id="employee_data">
            ...
            <tbody>
                ...
                <tr>
                       ...
                       <td>
                         <textarea style="text-align: left;" name="segment3[{{ $b }}][received_compliants_current_fy]" id="received_compliants_current_fy_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)"></textarea>
                       </td>

                       <td>
                         <textarea style="text-align: left;" name="segment3[{{ $b }}][pending_compliants_current_fy]" id="pending_compliants_current_fy_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)"></textarea>
                       </td>

                       <td>
                         <textarea style="text-align: left;" name="segment3[{{ $b }}][remarks_current_fy]" id="remarks_current_fy_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)"></textarea>
                       </td>
                        <td>
                         <textarea style="text-align: left;" name="segment3[{{ $b }}][received_compliants_previous_fy]" id="received_compliants_previous_fy_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)">  {{ $b == 5 ? $previous_data_privacy : ($b == 6 ? $previous_data_ad : ($b == 7 ? $previous_data_cyber : ($b == 8 ? $previous_data_delivery : ($b == 9 ? $previous_data_trade : ($b == 10 ? $previous_data_unfair : ($b == 11 ? $previous_data_other : '')))))) }}</textarea>
                       </td>
                       <td>
                         <textarea style="text-align: left;" name="segment3[{{ $b }}][pending_compliants_previous_fy]" id="pending_compliants_previous_fy_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)">{{ $b == 5 ? $previous_pending_data_privacy : ($b == 6 ? $previous_pending_data_ad : ($b == 7 ? $previous_pending_data_cyber : ($b == 8 ? $previous_pending_data_delivery : ($b == 9 ? $previous_pending_data_trade : ($b == 10 ? $previous_pending_data_unfair : ($b == 11 ? $previous_pending_data_other : '')))))) }}</textarea>
                       </td>
                        <td>
                         <textarea style="text-align: left;" name="segment3[{{ $b }}][remarks_previous_fy]" id="remarks_previous_fy_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)">{{ $b == 5 ? $previous_remarks_data_privacy : ($b == 6 ? $previous_remarks_data_ad : ($b == 7 ? $previous_remarks_data_cyber : ($b == 8 ? $previous_remarks_data_delivery : ($b == 9 ? $previous_remarks_data_trade : ($b == 10 ? $previous_remarks_data_unfair : ($b == 11 ? $previous_remarks_data_other : '')))))) }}</textarea>
                       </td>
                    </tr>
                    @php
                      $b++;
...
<div class="card card-success card-outline">
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($principle9_ques4->where('question_section','instance') as $key => $segment4)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <textarea style="text-align: left;" name="segment4[{{ $b }}][instant_number]" id="instant_number_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)"></textarea>
                                                            </td>
                                                            <td>
                                                                <textarea style="text-align: left;" name="segment4[{{ $b }}][recall_reason]" id="recall_reason_{{$b}}"  class="form-control form-control-sm auto-grow"  oninput="autoResize(this)"></textarea>
                                                            </td>
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment5[{{ $b }}][web_link]" id="web_link_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment6[{{ $b }}][corrective_actions]" id="corrective_actions_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment7[{{ $b }}][no_instances]" id="no_instances_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment8[{{ $b }}][breach_percent]" id="breach_percent_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment9[{{ $b }}][impact]" id="impact_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment10[{{ $b }}][channels]" id="channels_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment11[{{ $b }}][steps]" id="steps_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment12[{{ $b }}][risk]" id="risk_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
        ...
        <div class="card card-success card-outline mt-4">
             ...
             <div class="card-body p-1">
                <textarea class="form-control form-control-sm" name="segment13[{{ $b }}][product_info]" id="product_info_{{$b}}" placeholder="" rows="6"></textarea>
            </div>
             @php
              $b++;
             @endphp
