                                ...
                                <tr>
                                    ...
                                    <td style="width: 40%">
                                        <div class="form-check">
                                            <input  type="radio" name="answer[{{$value->id}}]" id="" style="       height: auto !important;" value="1"  @if($value->ans==1) checked @endif>
                                            <label class="form-check-label" for="1">
                                                {{$value->option1}}
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input  type="radio" name="answer[{{$value->id}}]" id="" style="       height: auto !important;" value="2"
                                        ...
                                        <div class="form-check">
                                            <input  type="radio" name="answer[{{$value->id}}]" id="" style="height: auto !important;" value="3" @if($value->ans==3) checked @endif>
                                            <label class="form-check-label" for="1"  >
                                                {{$value->option3}}
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            <input  type="radio" name="answer[{{$value->id}}]" id="" style="height: auto !important;" value="4"  @if($value->ans==4) checked @endif>
                                            <label class="form-check-label" for="1">
                                                {{$value->option4}}
                                            </label>
                                        </div>
            ...
            @endforeach
                        ...
                        <div class="row pb-2 mt-2">
                            ...
                            <div style="display: flex; gap: 10px;">
                                ...
                                <button type="submit" id="submit" class="btn btn-primary btn-md" style="display: flex; align-items: center;">
                                  <i class="fas fa-save" style="margin-right: 5px;"></i> Update
                                 </button>
            </form>

                                {{-- @endif --}}
                                <form action="{{ route('user.scoring.finalsubmit', ['module_mast_id'=>encrypt( $module_mast->id)]) }}" id="scoring_store" role="form" method="post"
           class='form-horizontal prevent_multiple_submit' files=true enctype='multipart/form-data'
           accept-charset="utf-8">
                                 <button type="submit" id="submit" class="btn btn-secondary btn-md" style="display: flex; align-items: center;">
                                    <i class="fas fa-store" style="margin-right: 5px;"></i>  Submit
                                 </button>
                                 @csrf
                                </form>
                            </div>
