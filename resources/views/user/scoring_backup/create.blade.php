                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 40%">
                                                    <div class="form-check">
                                                        <input  type="radio" name="answer[{{$value->id}}]" id="orange" value="1" style="       height: auto !important;">
                                                        <label class="form-check-label" for="1">
                                                            {{$value->option1}}
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input  type="radio" name="answer[{{$value->id}}]" id="orange" value="2" style="       height: auto !important;">
                                                        <label class="form-check-label" for="1">
                                                             {{$value->option2}}
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input  type="radio" name="answer[{{$value->id}}]" id="orange" value="3" style="       height: auto !important;">
                                                        <label class="form-check-label" for="1">
                                                      {{$value->option3}}
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <input  type="radio" name="answer[{{$value->id}}]" id="orange" value="4" style="       height: auto !important;">
                                                        <label class="form-check-label" for="1">
                                                             {{$value->option4}}
                                                        </label>
                                                    </div>
