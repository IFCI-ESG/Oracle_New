        ...
        <ul class="sub-menu">
         ...
         <li class="menu-item ">
                ...
                <div class="collapse" id="sidebarExposure">
                    <ul class="sub-menu">
                        <li class="menu-item">
                            <a href="{{ route('admin.user.index') }}" class="menu-link"><span class="menu-text">View Exposure List</span></a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('admin.adduser') }}" class="menu-link"><span class="menu-text">Add Exposure</span></a>
                        </li>
                        <li class="menu-item">
                            <a href="{{ route('admin.user.bulk.company.create') }}" class="menu-link"><span class="menu-text">Bulk Upload Exposure</span></a>
                        </li>
                    </ul>
                </div>
         </li>
            ...
            @elseif (Auth::user()->hasRole('SubAdmin'))
                ...
                <li class="menu-item">
                    ...
                    <li class="menu-item">
                    <a href="{{ route('admin.dash_governance') }}" class="menu-link"><span class="menu-text">Governance</span></a>
                    </li>
                    <li class="menu-item">
                    <a href="{{ route('admin.dash_scoring') }}" class="menu-link"><span class="menu-text">Scoring</span></a>
                    </li>
                    </ul>
                    </div>
                    </li>
