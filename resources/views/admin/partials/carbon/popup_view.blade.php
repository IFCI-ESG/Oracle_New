...
<form action="{{ route('user.questionnaire.update') }}" id="user_update" role="form" method="post" class='form-horizontal pop_view_prevent_multiple_submit'
    ...
    <input type="hidden" name="sec_id" value="{{ Auth::user()->sector_id }}">
            ...
            <span aria-hidden="true">Close[&times;]</span>
                ...
                <div class="row pb-2">
                    ...
                    <div class="col-md-2 offset-md-2">
                        <button type="button" data-bs-dismiss="modal" aria-label="Close" id="pop_view_close"
                            class="btn btn-danger btn-sm form-control form-control-sm" aria-label="Close">
