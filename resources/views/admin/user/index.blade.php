            ...
            <div class="card border-primary mt-3">
                <div class="card card-success card-outline textcolor shadow p-2">
                    <div class="d-flex justify-content-between align-items-center">
                        <h5 class="card-title mb-0">Corporate Exposure List1</h5>
                        <div class="dropdown">
                ...
                <table id="companyTable" class="table table-sm table-striped table-hover">
                    <thead>
                        <tr class="tablebgcolor text-center" style="font-size: 0.8rem; height: 40px;">
                            ...
                            <th class="border textcolor" style="padding: 8px 5px; text-align: center; vertical-align: middle;">Status</th>
                        ...
                        @if ($corp_detail)
                            @foreach ($corp_detail as $key => $user)
                                <tr>
                                    ...
                                    <td class="text-center" style="font-size:0.8rem;">{{$user->pan ? $user->pan : '--'}}</td>
                                    <td class="text-center" style="font-size:0.8rem;">{{$user->unique_login_id ? $user->unique_login_id : '--'}}</td>
