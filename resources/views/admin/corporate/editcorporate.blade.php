...
<div class="container-fluid">
    ...
    <div class="row ">
        <div class="col-md-12">
            <form action="{{ route('admin.corp_admin.update') }}" id="bankDetails_edit" role="form" method="post"
                ...
                <div class="card border-success m-2">
                    ...
                    <input type="hidden" value="{{ $corp_details->id }}" name="user_id">
                            ...
                            <table class="table table-sm table-striped  table-hover">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="pan" name="pan" value="{{ $corp_details->pan }}" readonly
                                                class="form-control form-control-sm text-right" style="width:80%"
                                                oninput="PanApi(this)" placeholder="ABCD0123456" required />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="corp_name" name="corp_name"
                                                value="{{ $corp_details->name }}" readonly
                                                class="form-control form-control-sm text-right" style="width:80%"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="cin" name="cin" value="{{ $corp_details->cin_llpin }}"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control form-control-sm" style="width:80%" name="reg_off_add" id="reg_off_add" rows="3" required>{{ $corp_details->reg_off_add }}</textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="reg_off_pin" name="reg_off_pin" onkeyup="GetCityByPinCode(this.value)"
                                                class="form-control form-control-sm text-right"  value="{{ $corp_details->reg_off_pin }}" style="width:80%"
                                                required />
                                                <span id="pincodeMsg"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="reg_off_state" name="reg_off_state"
                                                value="{{ $corp_details->reg_off_state }}" readonly
                                                class="form-control form-control-sm text-right" style="width:80%"
                                                 required />
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select id="reg_off_city" name="reg_off_city" style="width:80%"
                                                ...
                                                <option value="{{ $corp_details->reg_off_city }}" selected="selected">{{ $corp_details->reg_off_city }}</option>
                                            </select>
                                            {{-- <input type="text" id="city" name="city" value="{{ $corp_details->city }}"
                                                class="form-control form-control-sm text-right" style="width:80%" readonly
                                                 required /> --}}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <select id="sector_type" name="sector_type" class="form-control form-control-sm" style="width:80%" required>
                                                ...
                                                @foreach ($sectors as $sector)
                                                    <option value="{{ $sector->id }}" {{ $corp_details->sector_id == $sector->id ? 'selected' : ''}}>{{ $sector->name }}</option>
                                                @endforeach
                                           </select>
                                         {{-- <select id="bank_sector_type" name="bank_sector_type" class="form-control form-control-sm" style="width:80%" required>
                                            <option value="" disabled selected>Select Sector Type</option>
                                             <option value="public" {{ old('bank_sector_type', $corp_details->bank_sector_type) == 'public' ? 'selected' : '' }}>Public</option>
                                             <option value="private" {{ old('bank_sector_type', $corp_details->bank_sector_type) == 'private' ? 'selected' : '' }}>Private</option>
                                          </select> --}}
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="license_key" name="license_key"
                                                value="{{ $corp_details->license_key }}"
                                                class="form-control form-control-sm text-right" style="width:80%"
                                                required />
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="contact_person" name="contact_person"
                                                value="{{ $corp_details->contact_person }}"
                                                class="form-control form-control-sm text-right" style="width:80%"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" id="designation" name="designation"
                                                value="{{ $corp_details->designation }}"
                                                class="form-control form-control-sm text-right" style="width:80%"
                                        ...
                                        <td>
                                            <div style="display: flex; align-items: center;">
                                                ...
                                                <input type="text" id="altr_mobile" name="altr_mobile"
                                                    value="{{ $corp_details->altr_mobile }}"
                                                    class="form-control form-control-sm text-right" style="width:80%"
                                                    pattern="[0-9]{10}" maxlength="10" inputmode="numeric"
                                                    onkeypress="return event.charCode >= 48 && event.charCode <= 57"
            ...
            <div class="col-md-2 offset-md-0">
                <form action="{{ route('admin.corp_admin.submit') }}" id="final_submit" role="form" method="post"
