...
class CorporatePlantLocationController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        //     return redirect()->route('admin.additional_details.edit', $user->id);
        // }

        return view('admin.plantlocation.create', compact('user'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.plant.edit', $request->user_id);
    ...
    public function edit($user_id)
    {
        ...
        return view('admin.plantlocation.edit', compact('user', 'plantlocation'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        // try {
            ...
            // return redirect()->route('admin.edit_application',$request->id);
            return redirect()->back();
        // } catch (\Exception $e) {
        //     // errorMail($e, $request->app_id, Auth::user()->id);
        //     return redirect()->back();
